...
class ResturantListCreateAPIView(APIView):
    ...
    def get(self, request):
        ...
        serializer = ResturantSerializers(resturant, many=True)
    ...
    def post(self, request):
        serializer = ResturantSerializers(data=request.data)
...
class ResturantDetailAPIView(APIView):
    ...
    def get_object(self, pk):
        return get_object_or_404(Resturant, pk=pk)

    # GET - Single restaurant
    def get(self, request, pk):
        resturant = self.get_object(pk)
        serializer = ResturantSerializers(resturant)
    ...
    def put(self, request, pk):
        ...
        serializer = ResturantSerializers(
            resturant,
            data=request.data
        )
